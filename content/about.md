---
title: "About"
description: "Built by engineers, for startups."
...
<table style="width: 100%; border-collapse: collapse; margin: 2rem 0;">
  ...
  <tbody>
    ...
    <tr>
      <td style="border: 1px solid #ddd; padding: 1rem;"><strong>Ownership</strong></td>
      <td style="border: 1px solid #ddd; padding: 1rem;">We take responsibility for what we build.</td>
    </tr>
    <tr>
      <td style="border: 1px solid #ddd; padding: 1rem;"><strong>Velocity</strong></td>
      <td style="border: 1px solid #ddd; padding: 1rem;">Speed matters — without compromising reliability.</td>
    </tr>
    <tr>
      <td style="border: 1px solid #ddd; padding: 1rem;"><strong>Partnership</strong></td>
      <td style="border: 1px solid #ddd; padding: 1rem;">Your success is our success.</td>
    </tr>
  </tbody>
</table>
{{</section>}}
