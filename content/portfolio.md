...
projects:
  - title: "E-Commerce Platform Migration"
    ...
    description: "Migrated a legacy on-premise e-commerce platform to AWS with Kubernetes orchestration. Reduced deployment time from hours to minutes and cut infrastructure costs by 40%."
    results:
      - "40% cost reduction"
  ...
  - title: "FinTech CI/CD Transformation"
    ...
    description: "Built a fully automated CI/CD pipeline for a financial services company, including security scanning, automated testing, and zero-downtime deployments across multiple environments."
    results:
